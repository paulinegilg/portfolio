...
def generate_pdf(page_data, config_data, cv_data, public):
    # Set template
    ...
    # Render temp html
    page_html = cv_template.render(data=page_data, config_data=config_data, cv_data=cv_data, public=public)
